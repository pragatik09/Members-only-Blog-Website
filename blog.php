...
<head>
    ...
    <!-- Custom CSS -->
    <link href="css/perfectcup.css" rel="stylesheet">
        ...
        <div class="row">
            <div class="box">
                ...
                <div class="col-lg-12 text-center">
                    <img class="img-responsive img-border img-full" src="img/b1.png" alt="" style="height: 620px">
                    <h2>DALGONA COFFEE
                        <br>
                        <small>DECEMBER 25, 2022</small>
                    </h2>
                    <p>The viral Dalgona Coffee is nothing but our good ol' Whipped Coffee, easy to make and served upside down!</p>
                    <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Read More</button>
                    <hr>
                </div>
                <div class="col-lg-12 text-center">
                    <img class="img-responsive img-border img-full" src="img/b2.jpg" alt="" style="height: 620px">
                    <h2>IRISH COFFEE 
                        <br>
                        <small>NOVEMBER 09, 2022</small>
                    </h2>
                ...
                <div class="col-lg-12 text-center">
                    <img class="img-responsive img-border img-full" src="img/b3.jpg" alt="" style="height: 620px">
			...
			<div class="col-lg-12 text-center">
                    <img class="img-responsive img-border img-full" src="img/b4.jpg" alt="" style="height: 620px">
                    <h2>MATCHA LATTE 
                        <br>
                        <small>SEPTEMBER 18, 2022</small>
                    </h2>
                    <p>The slightly bitter matcha flavor mixed with the sweetness of coconut milk creates the perfect, creamy and balanced Matcha Latte.</p>
                    <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal3">Read More</button>
                    <hr>
                </div>	
